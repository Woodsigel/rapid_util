...
public:
    using type = typename remove_std_optional_impl<remove_const_and_reference_t<T>>::type;
};
...
public:
    constexpr static bool value = is_json_serializable_fixed_array_impl<std::remove_reference_t<remove_std_optional_t<T>>>::value;
};
...
public:
    constexpr static bool value = is_json_serializable_vector_impl< std::remove_reference_t<remove_std_optional_t<T>>>::value;
};
...
public:
    constexpr static bool value = is_json_serializable_list_impl<std::remove_reference_t<remove_std_optional_t<T>>>::value;
};
...
#define RAPIDJSON_UTIL_EXPAND_2(x, y) x, y
...
#define RAPIDJSON_UTIL_FOR_EACH_2(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_1(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_3(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_2(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_4(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_3(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_5(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_4(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_6(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_5(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_7(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_6(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_8(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_7(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_9(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_8(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_10(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_9(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_11(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_10(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_12(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_11(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_13(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_12(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_14(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_13(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_15(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_14(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_16(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_15(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_17(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_16(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_18(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_17(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_19(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_18(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_20(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_19(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_21(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_20(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_22(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_21(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_23(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_22(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_24(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_23(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_25(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_24(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_26(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_25(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_27(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_26(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_28(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_27(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_29(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_28(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_30(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_29(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_31(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_30(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_32(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_31(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_33(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_32(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_34(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_33(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_35(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_34(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_36(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_35(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_37(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_36(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_38(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_37(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_39(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_38(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_40(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_39(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_41(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_40(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_42(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_41(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_43(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_42(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_44(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_43(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_45(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_44(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_46(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_45(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_47(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_46(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_48(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_47(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_49(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_48(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_50(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_49(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_51(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_50(F, C, __VA_ARGS__))
#define RAPIDJSON_UTIL_FOR_EACH_52(F, C, x, ...) RAPIDJSON_UTIL_EXPAND_2(RAPIDJSON_UTIL_CALL(F, C, x),  RAPIDJSON_UTIL_FOR_EACH_51(F, C, __VA_ARGS__))
